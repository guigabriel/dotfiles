...
_G.packer_plugins = {
  ...
  ["awesome-vim-colorschemes"] = {
    loaded = true,
    path = "/home/gui/.local/share/nvim/site/pack/packer/start/awesome-vim-colorschemes",
  ...
  dracula = {
    loaded = true,
    path = "/home/gui/.local/share/nvim/site/pack/packer/start/dracula",
  ...
  ["move.nvim"] = {
    loaded = true,
    path = "/home/gui/.local/share/nvim/site/pack/packer/start/move.nvim",
